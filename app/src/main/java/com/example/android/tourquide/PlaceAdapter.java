...
public class PlaceAdapter extends ArrayAdapter<Place> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Find the TextView in the list_item.xml layout with the ID place_describe_text_view.
        TextView placeDescribeTextView = (TextView) listItemView.findViewById(R.id.place_describe_text_view);
        placeDescribeTextView.setText(currentPlace.getPlaceDescriptionId());
